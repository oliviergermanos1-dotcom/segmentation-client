...
COMPLEMENT = {
    ...
    # --- Gros volumes white spaces (caoutchouc, bois, agri, chimie, minerais) ---
    'SPODUMENE (MINERAIS)': 'MINING', 'CAOUTCHOUC USINE': 'AGRI BUSINESS',
    'CAOUTCHOUC NATUREL': 'AGRI BUSINESS', 'BOIS TRAVAILLES': 'AGRI BUSINESS',
    'NOIX DE KARITE': 'AGRI BUSINESS', 'SESAME': 'AGRI BUSINESS',
    'NOIX DE COCO': 'AGRI BUSINESS', 'AMANDE DE CAJOU': 'AGRI BUSINESS',
    'BANANES': 'AGRI BUSINESS', 'POLYVINYL CHLORIDE (PVC RESINE)': 'PRODUITS CHIMIQUES',
    'BEURRE DE KARITE': 'AGRI BUSINESS', 'EXCAVATOR': 'INFRASTRUCTURE',
    'PANNEAUX SOLAIR': 'ENERGIE', 'GRUME': 'AGRI BUSINESS',
    'POLYPROPYLÈNE': 'PRODUITS CHIMIQUES', 'UREE (UREA, PRODUIT CHIMIQUE)': 'PRODUITS CHIMIQUES',
    'POLYETHYLENE': 'PRODUITS CHIMIQUES', 'GRAINE DE ROUCOU': 'AGRI BUSINESS',
    'SODIUM HYDROXIDE (CHIMIE)': 'PRODUITS CHIMIQUES', 'BOIS EN GRUMES': 'AGRI BUSINESS',
    'CALCIUM CARBONATE (CHIMIE)': 'PRODUITS CHIMIQUES', 'TRAPAULINS': 'FMCG / RETAIL',
    'FERRAILLE DECHETS DE METAUX': 'MINING', 'MANGUES SECHEES': 'AGRI BUSINESS',
    'TOURTEAUX DE PALMISTE': 'AGRI BUSINESS', 'TOURTEAUX DE SOJA': 'AGRI BUSINESS',
    'GRAINES DE COTON': 'AGRI BUSINESS', 'FEVES DE CACAO': 'AGRI BUSINESS',
    'BEURRE DE CACAO': 'AGRI BUSINESS', 'HUILE DE PALME': 'AGRI BUSINESS',
}
